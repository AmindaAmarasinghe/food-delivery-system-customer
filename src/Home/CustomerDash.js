...
export function CustomerDash(){
    ...
    const [lastRiderId, setLastRiderId]=useState("");
    ...
    if(popupOpen){
        return(<Cart closeFunction={dialogclose} restaurantCart={restaurantCart} restaurantCartId={restaurantCartId} classT={this} setFeedbackFormOpen={setFeedbackFormOpen} setLastOrderId={setLastOrderId} setLastRiderId={setLastRiderId}/>);
    }

    return(
    <>
    <div className="row" style={{ backgroundRepeat:'no-repeat', height: '800px'}}>
        <div className="col-md-6 col-sm-12 d-flex justify-center pt-5" style={{backgroundColor: '#f29d9d'}}>
        ...
        <div className="col-md-6 col-sm-12" style={{paddingTop:'30px'}}>
            ...
            <FeedbackForm FeedbackFormOpen={feedbackFormOpen} lastOrderId={lastOrderId} lastRiderId={lastRiderId}/>
