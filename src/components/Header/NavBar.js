  ...
  if (isLoggedV) {
    ...
    <div className="row">
      ...
      <div className="row d-flex justify-content-end">
        ...
        width={'70px'}
        /></div>
      <div className="col-8 d-flex justify-left align-items-center text-white"><h5>{localStorage.getItem('username')}</h5></div>
      </div></Link></div>
        ...
        {/* <div className="navbar-container"> */}
          <a className=" col-md-6 col-sm-12 col-lg-4 text-white" style={{ cursor: "pointer",textDecoration: "none"}}>
            <div className="row" style={{display:"flex", alignItems:"center", justifyContent:"center"}}>
              ...
              <div className=" col-md-9 col-sm-12 col-12"><Link to="/home" style={{textDecoration:"none"}}><h2 className=" text-white text-center" >The Yum XPress</h2></Link></div>
            </div>
          </a>
